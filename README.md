# Zend Expressive Static Files [![Build Status](https://travis-ci.com/fduarte42/laminas-static-files.svg?branch=master)](https://travis-ci.com/fduarte42/laminas-static-files)
