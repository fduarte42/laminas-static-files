# Zend Expressive Static Files [![Build Status](https://api.travis-ci.com/fduarte42/laminas-static-files.svg?branch=master&status=passed)](https://app.travis-ci.com/github/fduarte42/laminas-static-files)
